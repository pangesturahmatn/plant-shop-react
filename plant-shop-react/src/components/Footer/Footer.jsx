            ...
            <Container className="center pt-5" fluid="xl">
                <Row>
                    <Col sm className="pb-4">
                        <h3 className="fw-bolder">PANGESTU RAHMAT N GARDEN</h3>
                        <p>
                    ...
                    <Col sm className="pb-4 d-flex flex-column">
                        ...
                        <a
                            className="mb-2"
                            href="mailto: pangstu.rahmat19@gmail.com"
                        >
                            <EnvelopeFill className="me-2" />
                            pangestu.rahmat19@gmail.com
                        </a>
                ...
                <p className="text-center small text-secondary pb-3 mb-0">
                    ©2025 Pangestu Rahmat N Garden All rights reserved
                </p>
            </Container>
        </Container>
    );
